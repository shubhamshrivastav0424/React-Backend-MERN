...
const latest = [
  {
    id: "55",
    imgurl: img4,
    title: "Cryptocurrency, New Regulations, and the FATF",
    content:
      "One of the biggest recent developments – and currently flying under most people’s radar -- is the new regulations from the inter-governmental Financial Action Task Force (FATF) that have been imposed upon crypto exchanges globally.",
  },
  {
    id: "56",
    imgurl: img5,
    title: "Facebook New Cryptocurrency",
    content:
      "Facebook—along with a consortium of some of the world’s most recognized financial firms, e-commerce and technology companies, academic institutions and venture capitalists",
  },
  {
    id: "57",
    imgurl: img6,
    title: "Is a Digital Asset a Security or … Is It Not?",
    content:
...
export const safety = [
...

  {
    id: 2,
    imgurl: img8,
    title: "Resilience : landmarks and references ",
    content:
  ...
  },
  {
    id: 3,
    imgurl: img9,
    title: "The Digital Aid Project Toolset ",
    content:
      "The challenging time we are all facing during the COVID-19 pandemic is incontestable. During the last few weeks, people and communities have shown solidarity worldwide like never before",
    cat: "Covid-19",
    blog_content:
  ...
  },
  {
    id: 4,
    imgurl: img10,
    title: "Supporting adaptive healthcare – people make the difference ",
    content:
      "In the past few weeks healthcare professionals have been fully focussed caring for enormous numbers of people infected with COVID-19. They did an amazing job.",
    cat: "Covid-19",
    blog_content:
...
export const verticalimg = [
  ...
  {
    imgurl: img13,
    title: "Top 6 tips on how to be a wildlife-friendly traveller",
  },
  {
    imgurl: img14,
    title:
...
export const stories = [
  {
    title: "Mumbai sees tallest waves in 100 years",
    content:
      "Sea waves rode the tarmac near the Gateway of India, Marine Drive, Juhu and Worli among other places today as India's financial capital was lashed by tidal waves 5.5 metres high, billed as the highest in 100 years. The high tide started at 2.05 pm and the waves are to ebb at 8.09 pm when it will reach the lowest level of 0.77 metre, the weather bureau said.",
  },
  {
    title: "Urban inequalities and heat risks in Delhi",
    content:
...
export const bollywood = [
  {
    ...
    content:
      "Deepika Padukone never fails to impress us with her style. The stunning actress is an epitome of grace and charm",
    cat: "bollywood",
    blog_content:
  ...
  },
  {
    ...
    imgurl: img17,
    title:
      "Katrina Kaif is impressed with the trailer of Alia Bhatt and Ranveer Singh’s Gully Boy",
    content:
      "Zoya Akhtar’s Gully Boy’s trailer has created a stir. The trailer of Ranveer Singh-Alia Bhatt starrer film was launched today and fans and members of the film fraternity went gaga over Ranveer and Alia’s look in the film .",
    cat: "bollywood",
    blog_content:
      "Zoya Akhtar’s Gully Boy’s trailer has created a stir. The trailer of Ranveer Singh-Alia Bhatt starrer film was launched today and fans and members of the film fraternity went gaga over Ranveer and Alia’s look in the film and complimented Zoya for dropping such a captivating trailer. Vicky Kaushal, Ayushmann Khurrana, Karan Johar and other celebs praised the film’s trailer on social media. Varun Dhawan also took to his Instagram account to share that he loved the trailer of Gully Boy.Katrina Kaif shared on her Instagram account the poster of Gully Boy and captioned it, “Awesome Trailer @zoieakhtar”. She tagged Ranveer Singh and Alia Bhatt in the photo.Alia Bhatt responded to Katrina by sharing her Instagram story on her account and wrote, “Wohoo thank you katty”. Alia Bhatt plays the role of a feisty girl in the film that is inspired from the life of rapper Divine.Ranveer Singh stole the show at the trailer launch event yesterday with his rapping.",
    imgurl2: img72,
  },
  {
    id: 7,
...
export const bolly = [
  {
    imgurl: img23,
    title:
      " Did Justin Bieber leave THIS comment on Ranveer Singh's song from Simmba, 'Aala Re Aala'?",
    cat: "bollywood",
  },
];
...
export const bollywoodright = [
  {
    ...
    imgurl: img24,
    title:
      "  #PinkvillaMoments: When actors spoke about their intimate & bold roles",
    cat: "bollywood",
  },
  {
    id: 41,
    imgurl: img25,
    title: " Rakhi Sawant's emotional reaction on Bappi Da",
    cat: "bollywood",
  },
  {
    id: 42,
    imgurl: img26,
    title: " Sonali Bendre and her husband giving us the couple goal ",
    cat: "bollywood",
  },
];
...
export const tech = [
  {
    imgurl: img67,
    title: " The Top 10 Tech Blogs to Follow in 2020",
    content:
      "Technology blogs are great resources if you want the latest tech news. Plus, they often feature interviews with industry leaders, updates from industry events, and other unique insights to help you stay up to date on all things tech.  ",
    cat: "technology",
  },
];
...
export const techright = [
  {
    ...
    content:
      "With over 7 million followers on social sites, AndroidAuthority is the largest publication dedicated to the world's most widely used operating system.  ",
    cat: "technology",
  },
  {
    id: 44,
    ...
    title: "How-To Geek",
    content:
      "How-To Geek is an online technology magazine created more than a decade ago, the site’s 10,000+ in-depth articles have been read over 1 billion times with more than 15 million readers every month.  ",
    cat: "technology",
  },
  {
    id: 45,
    ...
    title: " GeekWire ",
    content:
      "Started almost 10 years ago, Geekwire is a technology news site with loyal, tech-savvy readers around the globe, who follow for breaking news, expert analysis and unique insights into the technology industry.",
    cat: "technology",
  },
];
...
export const hollywood = [
  {
    ...
    imgurl: img27,
    title:
      " Kanye West Implies Kris Jenner & CoreyGamble Split In Dramatic Post: ‘He’s OffOn His Next Mission’",
    content:
      "Kanye West has started drama on his Instagram once again by implying that Kris Jenner and Corey Gamble have broken up",
    cat: "hollywood",
    blog_content:
      "Kanye West has given another hot take on Instagram and this time, he’s implying that his former mother-in-law Kris Jenner and her boyfriend Corey Gamble have split up. He uploaded a picture of Corey and wrote a cryptic message that makes it seem like he’s no longer part of Kris and the Kardashians’ lives. “God has a plan to remove the godless Corey needed to never be here anyway And I think he’s a nice person Not a great person,” he started off.Ye also listed reasons as to why he’s not a big fan of the Kardashian matriarch’s boyfriend and implied he got him kicked out of Chicago’s birthday. “He once told my wife he knew what music she should be listening to So when I seen him a week later I had him removed from my daughters birthday party,” he wrote. He also added some cryptic one-liners like “we still never met his family And I guess we never will” and “Now he’s off to his next mission His job is done He’s not messy enough to do something like this.”",
    imgurl2: img85,
  },
  {
    id: 20,
  ...
  },
  {
    ...
    imgurl: img29,
    title:
      "Hannah Lee Fowler: 5 Things To Know About Sam Hunt’s Pregnant Wife Who Is Divorcing Him",
    content:
      "Sam Hunt’s wife of five years filed for divorce from the ‘Take Your Time’ singer after years of their relationship being on and off.",
    cat: "hollywood",
    blog_content:
  ...
  },
  {
    ...
    content:
      "Aaron Rodgers reflected on his relationship with Shailene Woodley in an emotional Instagram post after they called off their engagement. ",
    cat: "hollywood",
    blog_content:
      "Just days after it was revealed that Aaron Rodgers, 38, and Shailene Woodley, 30, were breaking up and calling off their engagement, Aaron took to Instagram to praise his ex. The Green Bay Packers quarterback opened up about his relationship with Shailene as he reflected on the past year of his life. There’s definitely no bad blood on Aaron’s end regarding the end of their relationship.Aaron went on to thank some of his Packers coaches and teammates, and his words could be a hint about his future with the team. “To the men I got to share the QB room with everyday, Matt [LaFleur], Nathaniel [Hackett], Luke [Getsy], Jordan Love, Kurt Benkert, you guys made every day so much fun and I’m so thankful for the daily laughs and stress relief you brought me every week of the year. I love you guys,” Aaron wrote.“@shailenewoodley, thanks for letting me chase after you the first couple months after we met, and finally letting me catch up to you and be a part of your life,” Aaron began. “Thanks for always having my back, for the incredible kindness you show me and everyone you meet, and for showing me what unconditional love looks like, I love you and am grateful for you.”",
    imgurl2: img89,
  },
  {
    id: 24,
  ...
  },
  {
    ...
    imgurl: img33,
    title:
      "Penelope Disick, 9, TikToks With Dad Scott: ‘Too Excited To Go To Dinner’",
    content:
...
export const holly = [
  {
    imgurl: img34,
    title:
      "Gigi Hadid Slays Sexy Backless Dress ForH&M Ad After Split From Zayn Malik",
    cat: "hollywood",
  },
];
export const holly_right = [
  {
    ...
    imgurl: img35,
    title:
      "Queen Elizabeth, 95, Tests Positive ForCOVID-19 & Receives Outpouring OfPrayers",
    cat: "hollywood",
  },
  {
    id: 47,
    imgurl: img36,
    title:
      "Arnold Schwarzenegger HilariouslyButchers Son Patrick’s Hair With At HomeCut",
    cat: "hollywood",
  },
  {
    id: 48,
    imgurl: img37,
    title: "Smokey Robinson’s Kids: Everything ToKnow About His 3 Children",
    cat: "hollywood",
  },
];
export const fitness = [
  {
    id: 26,
    imgurl: img38,
    title: " How to Move Beyond Coping: Tools for Self-care ",
    content:
      "If you are feeling as though you are just getting by” these days, you might want to follow the example of those who live in the so-called blue zones and follow a lifestyle that leads to both greater longevity and overall health and well-being.",
    cat: "fitness",
    blog_content:
  ...
  },
  {
    id: 27,
    imgurl: img39,
    title: "A Simple Yet Powerful Method to Motivate Yourself to Exercise",
    content:
      "Learn how to take a mental victory lap each day while shifting your mood and mental state to a better one with this simple, yet powerful, technique.",
    cat: "fitness",
    blog_content:
  ...
  },
  {
    ...
    content:
      "Optimal health and fitness, the kind all of us need, come from constantly moving your body in ways that keep you available, keep you in the game. Because no matter how hard you can push",
    cat: "fitness",
    blog_content:
...
export const fit = [
  {
    imgurl: img45,
    title:
      "Better Ways to Implement the Health and Fitness Advice You are Tired of Hearing",
    cat: "fitness",
  },
];
export const fit_right = [
  {
    id: 49,
    imgurl: img46,
    title: "Benefits of HIIT for a Busy Schedule",
    cat: "fitness",
  },
  {
    id: 50,
    imgurl: img47,
    title: "6 Benefits of a Dynamic Warm-up for Running",
    cat: "fitness",
  },
  {
    id: 51,
...
export const food = [
  ...
  },
  {
    id: 36,
    imgurl: img52,
    title: "Cafe Latte Turtle Cake for Two",
    content:
  ...
  },
  {
    ...
    content:
      "These Red Chile Chicken Tacos are always on our minds! Lightly pan-fried corn tortillas stuffed with tender chicken and a pinto bean red chile saucy filling, piles of creamy corn salsa. YUM!",
    cat: "food",
    blog_content:
...
export const fastfood = [
  {
    imgurl: img56,
    title:
      "Kimchi Grilled Cheese - Golden brown, pan-fried Kimchi Grilled Cheese",
    content:
...
export const food_right = [
  ...
  },
  {
    id: 54,
    imgurl: img59,
    title: "Post-Holiday Coffee Date ",
    cat: "food",
  },
];
